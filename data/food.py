...
class Food(Dataset):
    ...
    def __init__(self, root, split='train',
        ...
        self.CLS2TXT = {key: value for key, value in zip(CLASS_NAME['food'], TEXT['food'])}
...
if __name__ == '__main__':
    ...
    train_dataset = Food(root, split='train')
    print(len(train_dataset))
    test_seen_dataset = Food(root, split='test_seen')
    print(len(test_seen_dataset))
    test_unseen_dataset = Food(root, split='test_unseen')
